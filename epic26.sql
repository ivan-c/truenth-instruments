...
(@question_id + 3,'radio',0,0,NULL,'0',NULL,'No problem<br/>0',NULL,'visible','No problem',1),
(@question_id + 3,'radio',0,0,NULL,'1',NULL,'Very Small Problem<br/>1',NULL,'visible','Very Small Problem',2),
(@question_id + 3,'radio',0,0,NULL,'2',NULL,'Small Problem<br/>2',NULL,'visible','Small Problem',3),
(@question_id + 3,'radio',0,0,NULL,'3',NULL,'Moderate Problem<br/>3',NULL,'visible','Moderate Problem',4),
(@question_id + 3,'radio',0,0,NULL,'4',NULL,'Big Problem<br/>4',NULL,'visible','Big Problem',5),
...
(@question_id + 9,'radio',0,0,NULL,'0',NULL,'No problem<br/>0',NULL,'visible','No problem',1),
(@question_id + 9,'radio',0,0,NULL,'1',NULL,'Very Small Problem<br/>1',NULL,'visible','Very Small Problem',2),
(@question_id + 9,'radio',0,0,NULL,'2',NULL,'Small Problem<br/>2',NULL,'visible','Small Problem',3),
(@question_id + 9,'radio',0,0,NULL,'3',NULL,'Moderate Problem<br/>3',NULL,'visible','Moderate Problem',4),
(@question_id + 9,'radio',0,0,NULL,'4',NULL,'Big Problem<br/>4',NULL,'visible','Big Problem',5),
...
(@question_id + 15,'radio',0,0,NULL,'1',NULL,'Very Poor to None<br/>1',NULL,'visible','Very Poor to None',1),
(@question_id + 15,'radio',0,0,NULL,'2',NULL,'Poor<br/>2',NULL,'visible','Poor',2),
(@question_id + 15,'radio',0,0,NULL,'3',NULL,'Fair<br/>3',NULL,'visible','Fair',3),
(@question_id + 15,'radio',0,0,NULL,'4',NULL,'Good<br/>4',NULL,'visible','Good',4),
(@question_id + 15,'radio',0,0,NULL,'5',NULL,'Very Good<br/>5',NULL,'visible','Very Good',5),
...
(@question_id + 21,'radio',0,0,NULL,'0',NULL,'No problem<br/>0',NULL,'visible','No problem',1),
(@question_id + 21,'radio',0,0,NULL,'1',NULL,'Very Small Problem<br/>1',NULL,'visible','Very Small Problem',2),
(@question_id + 21,'radio',0,0,NULL,'2',NULL,'Small Problem<br/>2',NULL,'visible','Small Problem',3),
(@question_id + 21,'radio',0,0,NULL,'3',NULL,'Moderate Problem<br/>3',NULL,'visible','Moderate Problem',4),
(@question_id + 21,'radio',0,0,NULL,'4',NULL,'Big Problem<br/>4',NULL,'visible','Big Problem',5),
